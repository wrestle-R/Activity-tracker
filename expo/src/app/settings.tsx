...
export default function SettingsScreen() {
  const { colors, preference, setPreference } = useSweatlineTheme(); const { syncNow, syncStatus } = useActivities();
  ...
  const sync = async () => { setWorking(true); await syncNow(); setWorking(false); };
