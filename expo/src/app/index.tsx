...
const styles = StyleSheet.create({ header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: spacing.xl }, brand: { flexDirection: 'row', alignItems: 'center', gap: 10 }, mark: { width: 46, height: 46, borderRadius: 12, alignItems: 'center', justifyContent: 'center' }, scoreCard: { padding: spacing.lg }, scoreTop: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: spacing.sm }, scoreBody: { alignItems: 'center', gap: spacing.lg, paddingTop: spacing.sm }, breakdown: { width: '100%', gap: 13 }, scoreRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, scoreLabel: { flexDirection: 'row', alignItems: 'center', gap: 9 }, dot: { width: 9, height: 9 }, explainer: { fontSize: 14, lineHeight: 20 }, actions: { gap: spacing.sm }, stats: { flexDirection: 'row', gap: spacing.sm }, stat: { flex: 1 }, feed: { gap: 0, paddingVertical: 0 }, feedRow: { minHeight: 78, flexDirection: 'row', alignItems: 'center', gap: 11, paddingVertical: 13 }, activityIcon: { width: 42, height: 42, borderRadius: 12, alignItems: 'center', justifyContent: 'center' }, feedCopy: { flex: 1 }, feedValue: { alignItems: 'flex-end' } });
