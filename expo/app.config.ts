...
const app: ExpoConfig = {
  ...
  extra: { webUrl: process.env.EXPO_PUBLIC_WEB_URL ?? process.env.APP_URL, supabaseUrl: process.env.SUPABASE_URL, supabasePublishableKey: process.env.SUPABASE_PUBLISHABLE_KEY, router: {}, eas: { projectId: "73c97f6a-2adf-493b-8d7e-61c6cbbb298c" } },
};
